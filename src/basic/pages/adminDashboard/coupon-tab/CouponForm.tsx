...
export default function CouponForm({
  ...
  const handleChangeFormCode = (e: React.ChangeEvent<HTMLInputElement>) => {
    setCouponForm({ ...couponForm, code: e.target.value.toUpperCase() });
  };

  const handleChangeFormDiscountType = (e: React.ChangeEvent<HTMLSelectElement>) => {
    setCouponForm({ ...couponForm, discountType: e.target.value as 'amount' | 'percentage' });
  };

  const handleChangeFormDiscountValue = (e: React.ChangeEvent<HTMLInputElement>) => {
  ...
  const handleBlurFormDiscountValue = (e: React.FocusEvent<HTMLInputElement>) => {
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <select
              ...
              onChange={handleChangeFormDiscountType}
              className="w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 px-3 py-2 border text-sm"
            >
          ...
          <div>
            ...
            <input
              ...
              onChange={handleChangeFormDiscountValue}
              onBlur={handleBlurFormDiscountValue}
              className="w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 px-3 py-2 border text-sm"
