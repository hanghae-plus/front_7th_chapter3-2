...
const AdminPage = ({ products, coupons, addNotification, addProduct, updateProduct, deleteProduct, addCoupon, deleteCoupon }: AdminPageProps) => {
  const { activeTab, setActiveTab } = useTabs<'products' | 'coupons'>('products');
  ...
  return (
    <div className='max-w-6xl mx-auto'>
      ...
      <Tabs value={activeTab} onChange={setActiveTab}>
        <TabList>
          <Tab value='products'>상품 관리</Tab>
          <Tab value='coupons'>쿠폰 관리</Tab>
        </TabList>
